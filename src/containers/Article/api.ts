...
import type { GetReplyParams, SubmitCommentParams, SubmitReplyParams, ReplyLikedParams } from 'containers/Article/types'
...
export const saveCommentLiked = (data: any) => POST('/article/comment/liked/save', data)
